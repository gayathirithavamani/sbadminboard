  ...
  return (
    <nav className="navbar navbar-expand navbar-light bg-dark topbar mb-4 static-top shadow">
      ...
      <ul className="navbar-nav ml-auto">
        ...
        {/* <!-- Nav Item - Messages --> */}
        <Link className="nav-item dropdown no-arrow mx-1">
          <Link
            className="nav-link dropdown-toggle"
            id="messagesDropdown"
            role="button"
        ...
        <li className="nav-item dropdown no-arrow">
          ...
          >
            ...
            <img
              ...
              alt="img-profile"
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQsp5sxcPJL4bhJVOQ8jlmooPeGCHcIeHKWaw&usqp=CAU"
            />
          </Link>
          {/* <!-- Dropdown - User Information --> */}
          <div
            className="dropdown-menu bg-dark dropdown-menu-right shadow animated--grow-in"
